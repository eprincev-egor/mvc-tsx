    ...
    template(group) {
        return react_1.default.createElement("div", { className: "ChatGroup" },
            react_1.default.createElement("div", { className: "ChatGroup--head" },
                react_1.default.createElement("div", { className: "ChatGroup--avatar fas fa-image" },
            ...
            react_1.default.createElement("div", { className: "ChatGroup--users" }, group.filteredUsers.map(user => react_1.default.createElement(user_1.UserView, { model: user, key: user.id }))),
...
class UserView extends mvc_tsx_1.View {
    template(user) {
        return react_1.default.createElement("div", { className: "ChatUser" },
            ...
            react_1.default.createElement("div", { className: "ChatUser--userName" }, this.getHighlightedName(user)),
