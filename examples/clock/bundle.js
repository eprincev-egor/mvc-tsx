...
/***/ "./examples/clock/ClockController.ts":
...
const mvc_tsx_1 = __webpack_require__("mvc-tsx");
class ClockModel extends mvc_tsx_1.Model {
    constructor() {
        super(...arguments);
        this.time = new Date();
    }
...
module.exports = __webpack_require__("./examples/clock/index.tsx");
